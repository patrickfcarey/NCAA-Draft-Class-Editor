...
| M09 / M12 franchise compilers               | Same approach as M08 with per-game base year + own templates              | ✅ Built end-to-end for 2018: M09 SEYR=10 (base 2008), M12 SEYR=7 (base 2011), both at $177.2M cap. Templates from user's Week-1-fresh saves (M12 from Deluxe ISO, consistent with roster pipeline). PCSX2 verification pending.             |
